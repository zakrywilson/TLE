...
import static com.zakrywilson.astro.tle.TLEFormatterTest.TLEElement.*;

/**
 * Tests {@link TLEFormatter}.
 *
 * @author Zach Wilson
 */
public class TLEFormatterTest {
     ...
     */
    @Test
    public void formatLine1() throws Exception {
        String line1, line1Expected;
        int satelliteNumber;
        char classification;
     ...
     */
    @Test
    public void formatLine2() throws Exception {
        String line2, line2Expected;
        int satelliteNumber;
        double inclination;
        double raan;
        double eccentricity;
